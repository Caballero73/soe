...
$('#submit-login').click(function(){
  ...
  else if (name == 'Micaela' || name == 'micaela') {
...
$('#btn-agregar-carro').click(function(){
  swal({
    ...
    text: 'Este carro quedará asignado a la Compañía.',
    type: 'warning',
    ...
    if (result.value) {
      swal({
        ...
        html:
          '<p>El carro ha sido asignado</p>' +
          '<a class="button success" style="color:white;border:none;font-weight: bold;" href="admon04.html">Aceptar</a>',        
      })
    }
  })
});
...
$('#confirmar-borrar-funcionario').click(function(){
  swal({
    title: '¿Está Usted seguro?',
    text: 'Este funcionario quedará eliminado del listado.',
    type: 'warning',
    showCancelButton: true,
    confirmButtonColor: '#339999',
    cancelButtonColor: '#FF301D',
    ...
    if (result.value) {
      swal({
        ...
        showConfirmButton: false,
        html:
          '<p>El funcionario ha sido eliminado</p>' +
          '<a class="button success" style="color:white;border:none;font-weight: bold;" href="cliente03.html">Aceptar</a>',        
      })
    }
  })
});
...
// Eviar Listado Sectorizado
$('#enviar-listado').click(function(){
  swal({
    title: '¿Está Usted seguro?',
    text: 'Este listado será enviado a los médicos correspondientes y luego ya no podrá ser modificado.',
    type: 'warning',
    showCancelButton: true,
    confirmButtonColor: '#339999',
    cancelButtonColor: '#FF301D',
    ...
    if (result.value) {
      swal({
        ...
        showConfirmButton: false,
        html:
          '<p>El listado ha sido enviado</p>' +
...
$(document).ready(function() {
    ...
    $('#agregar-medico').select2({
    });
    $('#agregar-barrios').select2({
    });
    ...
    // Cargar imagen de carro nuevo
    function init() {
      var inputFile = document.getElementById('cargar-foto-carro');
    ...
    function mostrarImagen(event) {
      ...
      reader.onload = function(event) {
        var img = document.getElementById('foto-carro-nuevo');
    ...
    // Cargar imagen de personal nuevo
    function init() {
      var inputFile = document.getElementById('cargar-foto-personal');
      inputFile.addEventListener('change', mostrarImagen, false);
    }
    ...
    function mostrarImagen(event) {
      ...
      var reader = new FileReader();
      reader.onload = function(event) {
        var img = document.getElementById('foto-personal-nuevo');
        img.src= event.target.result;
      }
      reader.readAsDataURL(file);
    }
    ...
    $(".btn-asignar-carro").click(function(){
